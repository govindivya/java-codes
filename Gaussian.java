...
public class Gaussian {                     // this program is to solve eqn using Gaussian Elimination method;
private double [][]m;
...
public Gaussian(int eqns) {              // constructor;
...
public static void main(String args[]) {
	...
	Gaussians obj=new Gaussians(sc.nextInt());
	obj.InputMatrix();
	obj.eliminate();
	obj.printSolution();
//	obj.eigenValues();
